...
#
# NOTE: This version is mostly identical to upstream (bzrlib.lazy_import), except that all custom
# exceptions are replaced with RuntimeError and it has been passed through 2to3.
...
class ScopeReplacer(object):
    ...
    def _resolve(self):
        ...
        if real_obj is None:
            ...
            if obj is self:
                raise RuntimeError(name, msg="Object tried"
...
class ImportProcessor(object):
    ...
    def _canonicalize_import_text(self, text):
        ...
        if cur is not None:
            raise RuntimeError(cur, 'Unmatched parenthesis')
        return out
